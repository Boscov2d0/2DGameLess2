...
internal class MainController : BaseController
{
    ...
    private PausePanelController _pauseController;
    private ButtonPauseController _toMenuController;
    ...
    private void OnChangeGameState(GameState state)
    {
        ...
        switch (state)
        {
            ...
            case GameState.Game:
                ...
                _toMenuController = new ButtonPauseController(_placeForUi, _profilePlayer);
                break;
            ...
            case GameState.Pause:
                _pauseController = new PausePanelController(_placeForUi, _profilePlayer);
                break;
        }
    }
